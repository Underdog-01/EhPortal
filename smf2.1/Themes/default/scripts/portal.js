// Version 1.1; portal.js

// Define the version of SMF that we are using.
portal_smf_version = 2.1;
...
function sp_collapse_object(id, has_image)
{
	...
	if (typeof(has_image) == "undefined" || has_image == true)
		document.getElementById("sp_collapse_" + id).src = smf_images_url + (mode ? '/collapse.png' : '/expand.png');
}
...
{
	something.style.backgroundImage = 'url(' + smf_images_url + (mode ? '/sp_shoutbox/bbc_hoverbg.png)' : '/sp_shoutbox/bbc_bg.png)');
}
